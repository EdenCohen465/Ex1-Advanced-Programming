...
admin_messages.set('edencohen', [{ time: "13:43", message: a, displayMessage: "photo", type: "photo", public: true, iSent: true }, { time: "13:50", message: video1, displayMessage: "video", type: "video", public: true, iSent: false }]);
admin_messages.set('israelisraeli', [{ time: "16:23", message: b, displayMessage: "photo", type: "photo", public: true, iSent: false }]);
...
admin_messages.set('tallevi', [{ time: "14:45", message: f, displayMessage: "photo", type: "photo", public: true, iSent: true }, { time: "14:57", message: "Thanks!!", displayMessage: "Thanks!!", type: "text", iSent: false }]);
...
ronioded_messages.set('israelisraeli', [{ time: "19:00", message: c, displayMessage: "photo", type: "photo", public: true, iSent: true }]);
ronioded_messages.set('avicohen', [{ time: "02:59", message: d, displayMessage: "photo", type: "photo", public: true, iSent: false }]);
ronioded_messages.set('tallevi', [{ time: "06:00", message: video1, displayMessage: "video", type: "video", public: true, iSent: true }]);
...
edencohen_messages.set('admin', [{ time: "13:43", message: a, displayMessage: "photo", type: "photo", public: true, iSent: false }, { time: "13:50", message: video1, displayMessage: "video", type: "video", public: true, iSent: true }]);
...
israelisraeli_messages.set('admin', [{ time: "16:23", message: b, displayMessage: "photo", type: "photo", public: true, iSent: true }]);
israelisraeli_messages.set("ronioded", [{ time: "19:00", message: c, displayMessage: "photo", type: "photo", public: true, iSent: false }]);
...
israelisraeli_messages.set("avicohen", [{ time: "16:30", message: video1, displayMessage: "video", type: "video", public: true, iSent: true }]);
...
avicohen_messages.set("ronioded", [{ time: "02:59", message: d, displayMessage: "photo", type: "photo", public: true, iSent: true }]);
...
avicohen_messages.set("israelisraeli", [{ time: "16:30", message: video1, displayMessage: "video", type: "video", public: true, iSent: false }]);
avicohen_messages.set("tallevi", [{ time: "18:16", message: e, displayMessage: "photo", type: "photo", public: true, iSent: true }]);
...
tallevi_messages.set('admin', [{ time: "14:45", message: f, displayMessage: "photo", type: "photo", public: true, iSent: false }, { time: "14:57", message: "Thanks!!", displayMessage: "Thanks!!", type: "text", iSent: true }]);
tallevi_messages.set("edencohen", [{ time: "", message: "", displayMessage: "", type: "", iSent: "" }]);
tallevi_messages.set("ronioded", [{ time: "06:00", message: video1, displayMessage: "video", type: "video", public: true, iSent: false }]);
tallevi_messages.set("israelisraeli", [{ time: "", message: "", displayMessage: "", type: "", iSent: "" }]);
tallevi_messages.set("avicohen", [{ time: "18:16", message: e, displayMessage: "photo", type: "photo", public: true, iSent: true }]);
